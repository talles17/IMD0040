...
public class Relatorio {
	...
	void addPessoa() throws Exception {
		...
		try {
			...
			if (nome.matches("[0-9]+")) {
				throw new Exception("O nome n�o pode conter n�meros.");
			}
			...
			if (estadoCivil != 'S' && estadoCivil != 'C' && estadoCivil != 'V' && estadoCivil != 'D') {
				throw new Exception("Op��o inv�lida no Estado Civil");
			}
			if (aceitacao < 0 || aceitacao > 10) {
				throw new Exception("O grau de aceita��o deve ser entre 0 a 10.");
			}
		} finally {
